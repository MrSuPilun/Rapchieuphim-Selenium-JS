...
describe('Kiểm tra trường nội dung bình luận', async function () {
  ...
  it('T13 Bình luận - Nội dung không được chèn link', async () => fieldMessage("https://rapchieuphim.com/phim/one-piece-film-red", "Nội dung bình luận không được chèn link"));
